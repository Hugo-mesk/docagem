# -*- coding: utf-8 -*-
# Generated by Django 1.11.13 on 2018-07-13 21:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('object_id', models.PositiveIntegerField()),
                ('comment', models.ImageField(upload_to='', verbose_name='Description')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=60, verbose_name='Title')),
                ('equipment', models.CharField(blank=True, max_length=60, null=True, verbose_name='Equipment')),
                ('maker', models.CharField(blank=True, max_length=60, null=True, verbose_name='Maker')),
                ('serial_number', models.CharField(blank=True, max_length=60, null=True, verbose_name='Serial Number')),
                ('equipment_model', models.CharField(blank=True, max_length=60, null=True, verbose_name='Equipment Model')),
                ('description', models.TextField(verbose_name='Description')),
                ('chapter', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='items', to='jobs.Chapter')),
            ],
        ),
        migrations.CreateModel(
            name='Jobs',
            fields=[
                ...
                ('multiplier', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='Multiplier')),
                ('remarks', models.TextField(verbose_name='Remarks')),
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='jobs', to='jobs.Item')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('equipment_model', models.CharField(blank=True, max_length=60, null=True, verbose_name='Equipment Model')),
                ('description', models.TextField(verbose_name='Description')),
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='subitems', to='jobs.Item')),
            ],
        ),
        migrations.CreateModel(
            name='SubJobs',
            fields=[
                ...
                ('multiplier', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='Multiplier')),
                ('remarks', models.TextField(verbose_name='Remarks')),
                ('subitem', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='jobs.SubItem')),
            ],
            options={
